...
<script src='${EXTERNAL_URL }js/original-works/my-save.js' type='text/javascript'></script>
...
<body>
  ...
  <div class="container" style="height: 885px; border: 1px solid #eee; margin-top: 30px; padding: 0px;">
    ...
    <div class="l-n-service">
      ...
      <div class="save" style="border-left: 6px solid #4D72FE;">
        <div style="float: left; margin-left: 40px;">
          <img src="${EXTERNAL_URL }images/account/save-b.png" alt="">
        </div>
        <a style="font-size: 16px; color: #4D72FE; margin-left: 15px;" href="${EXTERNAL_URL }original-works/my-save.html">我的原创</a>
      </div>
<%--      <div class="chain">--%>
<%--        <div style="float: left; margin-left: 40px;">--%>
...
<%--      </div>--%>
  ...
  <div class="right-content">
    <h1 style="margin: 38px 0 0 48px">
      <b style="color: #040404; font-size: 20px">我的原创</b>
    </h1>
    <div style="margin-top: 44px">
      <div class="add-original-works"
        style="display:inline-block;cursor:pointer;width: 140px; height:45px; background: #96BFFF ; line-height: 45px; text-align: center; float: left; margin-left: 48px; color: #fff;">添加作品</div>
      <div class="search" style="float: right; margin-right: 30px;">
        ...
        <input type="text" name="search-original-name" id="search-original-name"
          ...
          alt="" id="search-btn" style="position: relative; left: -40px">
      </div>
    </div>
<%--    <p style="margin: 100px 0 20px 48px; color: #979797; font-size: 14px">管理列表中的内容，将享受确权存证、侵权检测、维权索赔等原创保护服务</p>--%>
    <div style="padding:0 50px;" class="myselftable"><table id="original-works-table"></table></div>
    <div class="row mt-30" style="margin-top: 6px;">
      <div class="col-lg-12">
        <%--<span>共 <label id="data-total">0</label> 条数据，已使用 <label id="used-space">0 GB</label>，还可使用 <label id="free-space">0 GB</label> 存储空间--%>
          <span style="padding-left: 50px;">共 <label id="data-total">0</label> 条数据，总存证空间<label id="total_space">0 GB</label>，已使用 <label id="used-space">0 GB</label><%--，还可使用 <label id="free-space">0 GB</label> 存储空间--%>
        </span>
      </div>
    </div>
  </div>
  <div class="foot" style="width: 100%; height: 240px; margin-top: 130px;">
