                ...
                <div class="row container-page-content">
                    <div class="col-lg-12 container-page-content-column">
                        ...
                        <div class="row title mt-30">
                            <div class="col-lg-12 text-center">
                                <c:choose>
                                    <c:when test="${userRealnameAuth.status eq 3 }">
                                        <span style="font-weight: bold;">等待审核</span>
                                    </c:when>
                                    <c:when test="${userRealnameAuth.status eq 5 }">
                                        <span style="font-weight: bold;">等待审核</span>
                                    </c:when>
                                    <c:when test="${userRealnameAuth.status eq 7 }">
                                        <span style="font-weight: bold;">打款失败</span>
                                    </c:when>
                                </c:choose>
                            </div>
                        </div>
                        <div class="row content mt-30">
                            <div class="col-lg-offset-3 col-lg-6 text-center">
                                <span style="color: #aaaaaa;">工作人员会在1-3个工作日内对您的企业信息进行审核，系统会向您的企业账户进行打款，然后登录预猫，填写收款金额和验证码，以完成企业认证。</span>
                            </div>
                        </div>
                        <div class="row mt-100">
                            <div class="col-lg-12 text-center">
                                <button type="button" class="btn btn-link color-btn form-control go-index" style="background-color: #005E9E; color: #FFFFFF; width: 160px; height: 42px;">返回首页</button>
                            </div>
                        </div>
                    </div>
                </div>
