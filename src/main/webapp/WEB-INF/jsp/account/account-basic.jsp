          ...
          <div class="row">
            ...
            <div class="col-xs-6">
              <div class="form-group">
                ...
                <div class="col-xs-7">
                  <p class="form-control-static" style="display: inline-block; margin-right: 20px;">${user.mobileForDisplay }</p>
          ...
          <div class="row" style="margin-top: 32px">
            ...
            <div class="col-xs-6">
              <div class="form-group">
                ...
                <div class="col-xs-9">
                  <p class="form-control-static" style="display: inline-block; margin-right: 20px;">${idNo }</p>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <%--<div class="col-xs-10" style="padding: 0px">--%>
                    <%--<div class="tab-content">--%>
                      <%--<div role="tabpanel" class="tab-pane active" id="for-display">--%>
                        ...
                        <%--</div>--%>
                        <%--<div class="col-sm-2" style="padding-left: 0px; padding-top: 7px;">--%>
                          <%--<c:if test="${hasStatement }">--%>
                            <%--<a href="#for-edit" aria-controls="for-display" role="tab" data-toggle="tab"><label style="color: #FF5169;cursor: pointer">修改</label></a>--%>
                          <%--</c:if>--%>
                        <%--</div>--%>
                      <%--</div>--%>
          ...
          <fieldset>
            <div id="update-password-div" class="form-group" style="margin-bottom: 30px">
              ...
              <div class="col-xs-5  real-pad" style="display: inline-block;">
                <input type="text" disabled id="disabledTextInput" class="form-control" placeholder="${user.mobileForDisplay }">
              </div>
                <button class="get-verifycode"
                        style="width: 142px; height: 40px; font-size: 14px; color: #fff; background: #7FC4FD; text-align: center; line-height: 40px; position: relative; left: -130px">发送验证码</button>
...
<%--                   style="display:inline-block;cursor:pointer;width: 142px; height: 40px; font-size: 14px; color: #fff; background: #7FC4FD; text-align: center; line-height: 40px; position: relative; left: -135px">发送验证码</div>--%>
          ...
          <div class="form-group ">
<%--            <div class="col-sm-offset-2 col-xs-10 real-up" style="margin: 120px 0 0 180px;cursor:pointer;line-height: 50px;">--%>
...
<%--            </div>--%>
    <div class="col-sm-offset-2 col-xs-10 real-up" style="margin: 50px 0 0 220px;border:none">
        <button class="to-submit mybluebtn" style="width:100%; border-radius: 25px;">提交</button>
        <input type="hidden" class="submit-update-pass">
    </div>
          </div>
        </div>
