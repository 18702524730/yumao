...
<link href='${EXTERNAL_URL }css/faq.css' rel='stylesheet' type='text/css'>
...
<body style="background-color: #F8F8F8;">
  ...
  <div class="problem-center">
    <c:forEach items="${list }" var="list">
      <div class="article01">
        <a href="${EXTERNAL_URL }faq/details?id=${list.id}"><b>${list.title }</b></a>
        <p>${list.content }</p>
        <span><fmt:formatDate value="${list.submitTime }" type="date" pattern="yyyy-MM-dd" /></span>
      </div>
    </c:forEach>
  </div>
  <footer class="index_footer" style="margin-top: 150px;">
    <div class="content">
      ...
      <p class="copy_info">
        <span class="icp"><a style="color: #fff;" href="//beian.miit.gov.cn" target="_blank">浙 ICP备 18028232号</a></span> <img src="${EXTERNAL_URL }images/index/beian.png" alt="" class="icon"> <span class="right"><a style="color: #fff;" target="_blank" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=33010402003546">浙公网安备 33010402003546号</a>
