...
<!--    导航-->
	...
	<div class="container" style="height:885px;border:1px solid #eee;margin-top:30px;padding:0px;">
		<div class="left-nav">
			...
			<div class="l-n-service">
				...
				<div class="protect" style="	border-left:6px solid #4D72FE;">
					...
					<a style="font-size:16px;color:#4D72FE;margin-left:15px;">我的维权</a>
		...
		<div class="right-content" >
			...
			<h1 style="margin:38px 0 0 48px"><b style="color:#040404;font-size:20px">我的维权</b></h1>
			<div style="margin-top:44px" >
			
				<button style="width:140px;height45px;background:rgba(77, 114, 254, 0.8);line-height: 45px ;text-align: center;float:left;margin-left:48px;color:#fff">添加维权</button>
			...
			<table class="table" style="margin:20px 0 0 48px;width:894px;text-align: center;">
				...
				<tr>
					...
					<td>奔跑的小猪</td>
					<td>待受理</td>
					<td>2017-06-31 08:50</td>
					<td><a href="" style="font-size:14px;color:#4D72FE">下载</a></td>
					<td><a href="" style="font-size:14px;color:#4D72FE">撤回</a></td>
				</tr>
				<tr>
					<td>www.baidu.com</td>
					<td>奔跑的小猪</td>
				...
				<tr>
					...
					<td>2017-06-31 08:50</td>
					<td><a href="" style="font-size:14px;color:#4D72FE">下载</a></td>
					<td><a href="" style="font-size:14px;color:#4D72FE">提交</a><span style="margin:0 5px">|</span><a href="" style="font-size:14px;color:font-size:14px;color:#FF5169">删除</a></td>
				</tr>
				<tr>
					<td>www.baidu.com</td>
					<td>奔跑的小猪</td>
				...
				<tr>
					...
					<td>2017-06-31 08:50</td>
					<td><a href="" style="font-size:14px;color:#4D72FE">下载</a></td>
					<td><a href="" style="font-size:14px;color:#4D72FE">维权结果</a></td>
				</tr>
