			...
			<form class="form-horizontal text-center" style="margin-top:40px ">
			  <div class="form-group" style="margin-bottom:30px ">
				...
				<div class="col-xs-5  real-pad">
				  <input type="text" class="form-control" id="inputEmail3" placeholder="请输入真实姓名">
				</div>
			  </div>
			  <div class="form-group" style="margin-bottom:30px ">
				<label for="inputPassword3" class="col-xs-4 control-label">身份证号：</label>
				<div class="col-xs-5 real-pad">
				  <input type="text" class="form-control" id="inputPassword3" placeholder="请输入身份证号">
				</div>
			  </div>
			 ...
			 <div class="form-group" style="margin-bottom:30px ">
				...
				<div class="col-xs-5 real-pad">
				  <input type="text" class="form-control" id="inputPassword3" placeholder="请输入预留手机号">
				</div>
			  </div>
			...
			<div class="form-group" style="margin-bottom:30px ">
			  ...
			  <div class="form-group " >
				<div class="col-sm-offset-2 col-xs-10 real-up" style="margin:40px 0 0 340px;border:none;" >
				  <button type="submit" class="mybluebtn" style="width:100%;border: 1px solid #707070;border-radius: 25px;">提交</button>
				</div>
			  </div>
			</form>			
