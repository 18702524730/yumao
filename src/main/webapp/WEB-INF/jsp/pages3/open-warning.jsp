...
<!--    导航-->
	...
	<div class="container"  style="margin-top:40px">
		...
		<div class="name-box text-center	">
			...
			<b style="font-size: 20px;color:#4D4F5C">实名认证申请已提交</b>
		
			<p style="color:#979797;font-size:16px;margin-top:17px">审核时间为1-2个工作日，不含法定节假日，<a href="" style="font-size:16px;color:#4D72FE">点击此处返回</a></p>
		
			<button style="width:200px; height:50px;border:1px solid #ddd;border-radius:25px;background:none;margin-top:90px;">重新认证</button>
