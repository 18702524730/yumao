...
<!--    导航-->
	...
	<div class="container" style="height:885px;border:1px solid #eee;margin-top:30px;padding:0px;">
		<div class="left-nav">
			...
			<div class="l-n-service">
				...
				<div class="save" style="	border-left:6px solid #4D72FE;">
					...
					<a style="font-size:16px;color:#4D72FE;margin-left:15px;">我的存证</a>
		...
		<div class="right-content" >
			...
			<h1 style="margin:38px 0 0 48px"><b style="color:#040404;font-size:20px">我的存证</b></h1>
			<div style="margin-top:44px" >
			
				<button style="width:140px;height45px;background:rgba(77, 114, 254, 0.8);line-height: 45px ;text-align: center;float:left;margin-left:48px;color:#fff">添加作品</button>
